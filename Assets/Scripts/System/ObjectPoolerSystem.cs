...
public class ObjectPoolerSystem : MonoBehaviour
{
    ...
    public static GameObject SpawFromPool(string tag, Vector3 position)
    {
        if (!poolDictionary.ContainsKey(tag))
            return null;
    ...
    public static GameObject SpawFromPool(string tag, Quaternion rotation)
    {
        if (!poolDictionary.ContainsKey(tag))
            return null;
    ...
    public static GameObject SpawFromPool(string tag)
    {
        if (!poolDictionary.ContainsKey(tag))
            return null;
